...
class ControllerAccountCustomerpartnerSoldinvoice extends Controller {
	...
	public function index() {
		...
		$this->data['text_total_order'] = $this->language->get('text_total_order');
                         ...
                         $this->data['mpauction_status']= $this->config->get('wkproduct_auction_status');
            ...
            $shipping  = 0;
        		...
        		$this->data['products'][] = array(
        			'product_id' => $product['product_id'],
          			...
          			'price'    => $this->currency->format($product['price'] + ($this->config->get('config_tax') ? $product['tax'] : 0), $order_info['currency_code'], $order_info['currency_value']),
                        ...
                        'coupon_price' => $this->currency->format('-'.$product['coupon_price'], $order_info['currency_code'], 1),
                        'total' => $this->currency->format($product['c2oprice'], $order_info['currency_code'], 1),
      		...
      		if($totals AND isset($totals[0]['total'])){
				...
				$this->data['totals']['total'] = array(
					   ...
					   'title'  => 'Total',
					   'text'   => $this->currency->format($totals[0]['total']+$shipping, $order_info['currency_code'], $order_info['currency_value']),
			    );
			}
