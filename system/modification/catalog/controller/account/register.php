...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		//else {  // one add
		//	$this->response->redirect($this->url->link('common/hometv', '', 'SSL'));  // one add
		//} // one add
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/register.tpl')) {
