...
class ControllerProductManufacturer extends Controller {
	public function index() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_list.tpl')) {
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_info.tpl')) {
