...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		$this->load->model('tool/image');
            ...
            $data['auctionProduct'] = $this->model_module_wkproduct_auction->getProductAuction();
                          }
		...
		if (isset($this->request->get['affiliate'])) {
			$affiliate = $this->request->get['affiliate'];
		} else {
			$affiliate = '';
		}
		...
		if (isset($this->request->get['affiliate'])) {
			$url .= '&affiliate=' . $this->request->get['affiliate'];
		}
		...
		$data['affiliates'] = $this->model_catalog_product->getAffiliates();	
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			$filter_data = array(
				...
				'filter_affiliate_id' => $affiliate_id,	'filter_category_id'  => $category_id,
            ...
            if($this->config->get('wkproduct_auction_status') && $this->config->get('wkproduct_auction_cartstatus')){
                $data['wk_cart_option'] = true;                  
                }else{
                  $data['wk_cart_option'] = false;
                }
