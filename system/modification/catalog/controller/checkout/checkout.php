...
class ControllerCheckoutCheckout extends Controller {
	public function index() {
			...
			$product_total = 0;
                                        ...
                                        if($this->config->get('marketplace_status')) {
                                            ...
                                            if(!$allowedProductBuy) {
                                                ...
                                                $this->session->data['sellerProducts'] = $productName;
                                                $this->response->redirect($this->url->link('checkout/cart'));
                                            }
                                        }
		...
		if (isset($this->session->data['agent_id'])) {
			...
			$this->model_account_activity->logActivity('checkout/checkout','order', $log_data);

		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/checkout.tpl')) {
