  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered table-hover">
        <thead>
          <tr>
            <td class="text-left" colspan="2"><?php echo $text_customer; ?></td>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td class="text-left" style="width: 50%;">
              <b><?php echo $text_custname; ?></b> <?php echo $custname; ?><br />
              <b><?php echo $text_custtel; ?></b> <?php echo $custtel; ?><br />
			 </td>
            <td class="text-left">
              <b><?php echo $text_custmobile; ?></b> <?php echo $custmobile; ?><br />
              <b><?php echo $text_custfax; ?></b> <?php echo $custfax; ?>
			 </td>
          </tr>
        </tbody>
      </table>	  
        ...
        <tbody>
          <tr>
            ...
            <td class="text-left"><?php if ($payment_method) { ?>
              ...
              <?php } ?>
			  <b><?php echo $text_ordertel; ?></b> <?php echo $ordertel; ?>
			 </td>
          </tr>
        </tbody>
      </table>
            ...
            <tr>
              ...
              <!-- <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                ...
                <?php } ?>
                        ...
                        <!-- marketplace -->
                <a onclick = "getProductOrderStatus(<?php echo $product['order_id'];?>,<?php echo $product['product_id'];?>)" data-toggle="tooltip" title="<?php echo $button_order_detail; ?>" class="btn btn-primary"><i class="fa fa-truck"></i></a>
