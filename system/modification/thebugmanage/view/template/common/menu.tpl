<ul id="menu">
  <li id="dashboard"><a href="<?php echo $home; ?>"><i class="fa fa-dashboard fa-fw"></i> <span><?php echo $text_dashboard; ?></span></a></li>
              ...
              <?php if(isset($wk_get_timezone)){ ?>
                <li id="bids"><a href="<?php echo $cp_bids ?>"><i class="fa fa-image fa-fw"></i><span><?php echo "Auction Bids"; ?></span></a>            
                </li>
              <?php } ?>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
    <ul>
      <li><a class="parent"><?php echo $text_sale; ?></a>
        <ul>
        	<li><a href="<?php echo $report_sale_account; ?>"><?php echo $text_report_sale_account; ?></a></li>
