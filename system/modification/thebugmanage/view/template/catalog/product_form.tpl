  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo $barcode; ?>" data-toggle="tooltip" title="barcode" class="btn btn-primary"><i class="fa fa-barcode"></i></a>
        </div>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?></a></li>
                            ...
                            <li><a href="#tab-custom-field" data-toggle="tab"><?php echo "Custom field"; ?></a></li>
                            <!-- Marketplace customfield -->
                              
            
                           <li><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
                            <?php if(isset($wkget_timezone)){ ?>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-warrantyday"><?php echo $entry_warrantyday; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="warrantyday" value="<?php echo $warrantyday; ?>" placeholder="<?php echo $entry_warrantyday; ?>" id="input-warrantyday" class="form-control" />
                </div>
              </div>
              <!-- one add 1/1 - end -->              
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-margintype">Margin type (P=%, F=Fix baht)</label>
                <!--div class="col-sm-10">
                  <input type="text" name="margintype" value="<?php echo $margintype; ?>" placeholder="P or F (Percent or Fixed)" id="input-margintype" class="form-control" size=1/>
                </div-->
			<div class="col-sm-10">
                  <select name="margintype" id="input-margintype" class="form-control">
                    <?php if ($margintype=='P') { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-marginvalue">Margin value</label>
                <div class="col-sm-10">
                  <input type="text" name="marginvalue" value="<?php echo $marginvalue; ?>" placeholder="" id="input-marginvalue" class="form-control" />
                </div>
              </div>              
          ...
          <!--Marketplace Customfield -->
                    ...
                    <?php if(isset($wkget_timezone)){ ?>
                            <div class="tab-pane" id="tab-auction">
                              <div class="form-group">
                                <label class="col-sm-2 control-label" ><?php echo $entry_isacution; ?></label>
                                <div class="col-sm-10">
                                  <label class="radio-inline">
                                  <input type="radio" name="isauction" value="1" <?php if($isauction) echo " checked" ?> />Yes</label>
                                  <label class="radio-inline">
                                  <input type="radio" name="isauction" value="0" <?php if(!$isauction) echo " checked"; ?> />No</label>
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-name"><?php echo $entry_auction; ?></label>
                                <div class="col-sm-10">                                 
                                  <input type="text" name="auction_name" value="<?php echo $auction_name;?>" class="form-control" id="input-name" />                                                                              
                                </div>
                              </div>
                             <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-min"><?php echo $entry_min; ?></label>
                                <div class="col-sm-10">                                 
                                  <input type="text" name="auction_min" value="<?php echo $auction_min;?>" class="form-control" id="input-min" />
                                  <?php if(isset($error_auction_min) && $error_auction_min) { ?>
                                    <div class="text-danger">
                                      <?php echo $error_auction_min; ?>
                                    </div>
                                  <?php } ?>
                                </div>
                              </div>
                              <div class="form-group required">
                                ...
                                <div class="col-sm-10">                                 
                                  <input type="text" name="auction_max" value="<?php echo $auction_max;?>" class="form-control" id="input-max" />
                                  <?php if(isset($error_auction_max) && $error_auction_max) { ?>
                                    <div class="text-danger">
                                      <?php echo $error_auction_max; ?>
                                    </div>
                                  <?php } ?>
                                </div>
                              </div>  
                              <div class="form-group required">
                                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $entry_sdate; ?>"><?php echo $entry_sdate; ?></span></label>
                                <div class="col-sm-3">
                                  <div class="input-group datetime">
                                          <input type="text" name="auction_start" value="<?php echo $auction_start;?>" placeholder="Auction Start" data-date-format="YYYY-MM-DD HH:mm:00" class="form-control">
                                          <span class="input-group-btn">
                                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                          </span>
                                  </div>
                                  <?php if(isset($error_auction_start) && $error_auction_start) { ?>
                                    <div class="text-danger">
                                      <?php echo $error_auction_start; ?>
                                    </div>
                                  <?php } ?>
                                </div>
                              </div> 
                              <div class="form-group required">
                                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $entry_date; ?>"><?php echo $entry_date; ?></span></label>
                                <div class="col-sm-3">
                                  <div class="input-group datetime">
                                          <input type="text" name="auction_end" value="<?php echo $auction_end;?>" placeholder="Auction End" data-date-format="YYYY-MM-DD HH:mm:00" class="form-control">
                                          <span class="input-group-btn">
                                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                          </span>
                                  </div>
                                  <?php if(isset($error_auction_end) && $error_auction_end) { ?>
                                    <div class="text-danger">
                                      <?php echo $error_auction_end; ?>
                                    </div>
                                  <?php } ?>
                                </div>
                              </div> 
                              <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-pquantity"><span data-toggle="tooltip" title="" data-original-title="<?php echo $help_quantitylimit; ?>"><?php echo $entry_quantitylimit; ?></span></label>
                                <div class="col-sm-10">                                 
                                  <input type="text" name="product_quantity_limit" value="<?php echo $product_quantity_limit;?>" class="form-control" id="input-pquantity" />                                                       
                                </div>
                              </div>  
                                <div class="form-group">
                                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $help_voucherlimit; ?>"><?php echo $entry_voucherlimit; ?></span></label>
                                <div class="col-sm-3">
                                  <div class="input-group datetime">
                                          <input type="text" name="voucher_expiry" value="<?php echo $voucher_expiry;?>" placeholder="Date Available" data-date-format="YYYY-MM-DD" class="form-control">
                                          <span class="input-group-btn">
                                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                          </span>
                                  </div> 
                                  <?php if(isset($error_voucher_expiry) && $error_voucher_expiry) { ?>
                                    <div class="text-danger">
                                      <?php echo $error_voucher_expiry; ?>
                                    </div>
                                  <?php } ?>                                                                             
                                </div>
                              </div>                                                        
