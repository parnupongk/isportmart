...
// Entry
	...
	$_['entry_warrantyday']            = 'Warranty duration (day)';
...
// Error
                                ...
                                $_['entry_quantitylimit']   = 'Product Quantity Limit';
                                $_['entry_voucherlimit']        = 'Voucher Time Limit'; 
                                $_['help_quantitylimit']   = 'Enter Minimum Product Quantity For Auction';
                                $_['help_voucherlimit']        = 'Enter Date After which voucher will Expire';
                                $_['error_auction_min']        = 'Please enter minimum price for auction';
                                $_['error_auction_max']        = 'Please enter maximum price for auction';
                                $_['error_auction_minmax']        = 'Maximum price must be greater than minimum';
                                $_['error_auction_start']        = 'Please enter starting time for auction';
                                $_['error_auction_end']        = 'Please enter ending time for auction';
                                $_['error_auction_startend']        = 'Ending time must be greater than starting time';
                                $_['error_voucher_expiry']        = 'Voucher limit must be greater than ending date';
