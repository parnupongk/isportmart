...
class ControllerModuleMarketplace extends Controller {
	...
	public function index() {
		...
		$config_data = array(
				...
				// 'marketplace_seller_address_invoice',
		...
		$data['product_tabs'] = array('special','discount','attribute','links','options','custom-field');
         ...
         */
            ...
            /*
            Add option to existing array
             */
            if($this->config->get('wkproduct_auction_status')) {
                $data['wkproduct_auction_status'] = true;
                $data['account_menu']['auction'] = $this->language->get('entry_mod_auction');
                $data['marketplace_account_menu_sequence']['auction'] = $this->language->get('entry_mod_auction');
            } else {
                $data['wkproduct_auction_status'] = false;
                if(isset($data['marketplace_account_menu_sequence']['auction'])) {
                    unset($data['marketplace_account_menu_sequence']['auction']);
                }
                if(isset($data['marketplace_account_menu_sequence']['auction'])) {
                    unset($data['marketplace_account_menu_sequence']['auction']);
                }
