...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['session_usergrp'] = $this->session->data['user_group'];
		...
		$data['text_report_sale_account'] = $this->language->get('text_report_sale_account');
		...
		$data['text_report_customer_history'] = $this->language->get('text_report_customer_history');
		...
		$data['report_sale_account'] = $this->url->link('report/sale_account', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['report_customer_history'] = $this->url->link('report/customer_history', 'token=' . $this->session->data['token'], 'SSL');
    ...
    $data['menu_text_sellerlist'] = $this->language->get('menu_text_sellerlist');
    $data['menu_text_productlist'] = $this->language->get('menu_text_productlist');
    $data['menu_text_order'] = $this->language->get('menu_text_order');
    $data['menu_text_commission'] = $this->language->get('menu_text_commission');
    $data['menu_text_income'] = $this->language->get('menu_text_income');
    $data['menu_text_transaction'] = $this->language->get('menu_text_transaction');
    $data['menu_text_shipping'] = $this->language->get('menu_text_shipping');
    $data['menu_text_mail'] = $this->language->get('menu_text_mail');
    $data['menu_text_review'] = $this->language->get('menu_text_review');
    $data['menu_text_customfield'] = $this->language->get('menu_text_customfield');
    ...
    $data['cp_order'] = $this->url->link('customerpartner/order', 'token=' . $this->session->data['token'], 'SSL');
    ...
    $data['cp_mail'] = $this->url->link('customerpartner/mails', 'token=' . $this->session->data['token'],'SSL');
    $data['cp_review'] = $this->url->link('customerpartner/review', 'token=' . $this->session->data['token'],'SSL');
    $data['wk_customfield'] = $this->url->link('wkcustomfield/wkcustomfield', 'token=' . $this->session->data['token'], 'SSL');
                        

    $data['cp_bids'] = $this->url->link('catalog/wkauction_bids', 'token=' . $this->session->data['token'],'SSL');
                        $data['wk_get_timezone']  = $this->config->get('wkproduct_auction_timezone_set');
