...
//	define('HTTP_SERVER', 'http://' . $_SERVER['HTTP_HOST']. '/ishop/');
//	define('HTTPS_SERVER', 'https://' . $_SERVER['HTTP_HOST']. '/ishop/');
...
// DIR
define('DIR_APPLICATION', '/var/www/html/ishop/catalog/');
define('DIR_SYSTEM', '/var/www/html/ishop/system/');
define('DIR_LANGUAGE', '/var/www/html/ishop/catalog/language/');
define('DIR_TEMPLATE', '/var/www/html/ishop/catalog/view/theme/');
