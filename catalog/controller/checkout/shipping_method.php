...
class ControllerCheckoutShippingMethod extends Controller {
	public function index() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/shipping_method.tpl')) {
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->model_account_activity->logActivity('checkout/shipping_method/save','order shipping method', $log_data);
		}
