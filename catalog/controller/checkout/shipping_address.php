...
class ControllerCheckoutShippingAddress extends Controller {
	public function index() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/shipping_address.tpl')) {
			...
			if (isset($this->request->post['shipping_address']) && $this->request->post['shipping_address'] == 'existing') {
				...
				if (!$json) {
					...
					$log_data = array(
						...
						'data'    => $this->request->post['shipping_address']."//not add address"
					);
					$this->model_account_activity->logActivity('checkout/shopping_address/save','order shopping address', $log_data);
				}
			} else {
