...
class ControllerAccountReturn extends Controller {
	...
	public function index() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/return_list.tpl')) {
	...
	public function info() {
		...
		if ($return_info) {
			...
			} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/return_info.tpl')) {
	...
	public function add() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/return_form.tpl')) {
	...
	public function success() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/success.tpl')) {
