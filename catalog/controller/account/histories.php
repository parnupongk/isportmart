...
public function index() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/order.tpl')) {
...
if($order_info){
	if($this->request->get['order_status_id'] == 15){
...
//$this->index();
$this->response->redirect($this->url->link('account/histories','', 'SSL'));
	}			
}
...
public function OrderHistory() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/order_history.tpl')) {
...
public function invoice(){
	   ...
	   // store
			...
			} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/invoice.tpl')) {
...
public function invoice_tracking(){
	   ...
	   // store
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/customer_tracking.tpl')) {
