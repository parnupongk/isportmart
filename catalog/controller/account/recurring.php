...
class ControllerAccountRecurring extends Controller {
	public function index() {
		...
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/recurring_list.tpl')) {
	...
	public function info() {
		...
		if ($recurring) {
			...
			} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/recurring_info.tpl')) {
