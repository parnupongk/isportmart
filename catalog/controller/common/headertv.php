<?php
class ControllerCommonHeadertv extends Controller {
	public function index() {
		...
		if (isset($this->session->data['agent_id'])) {
			return $this->load->view('default/template/common/headertv.tpl', $data);
		} elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/headertv.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/headertv.tpl', $data);
		} else {
			return $this->load->view('default/template/common/headertv.tpl', $data);
		}
	}
