<form class="form-horizontal">
  ...
  <div id="payment-existing" style="display: <?php echo ($new_cust == 'Y' ? 'none' : 'block'); ?>;">
    <select name="address_id" class="form-control">
     <?php foreach ($addresses as $address) { ?>
      <?php if ($address['address_id'] == $address_id) { ?>
		<option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?> [แจ้งทาง <?php echo $address['informtype']; ?>]</option>
      <?php } else { ?>
		<option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?> [แจ้งทาง <?php echo $address['informtype']; ?>]</option>
      <?php } ?>
     <?php } ?>
    </select>
  </div>
  ...
  <?php } ?>
  <br />
  <div id="payment-new" style="display: <?php echo ($new_cust != 'Y' ? 'none' : 'block'); ?>;">   <!-- <?php echo ($addresses ? 'none' : 'block'); ?> -->
    <div class="form-group required">
	  <label class="col-sm-2 control-label"><?php echo $entry_inform; ?></label>
      <div class="col-sm-10">
		<label class="radio-inline"><input type="radio" name="inform" value="E" checked="checked" />Email</label>
		<label class="radio-inline"><input type="radio" name="inform" value="S" />SMS</label>
      </div>
    </div>	
    <div class="form-group required">
    ...
    <div class="form-group required">
      ...
      <div class="form-group required">
        <label class="col-sm-2 control-label" for="input-payment-mobile"><?php echo $entry_mobile; ?></label>
		<div class="col-sm-10">
        <input type="text" name="mobile" value="<?php echo $mobile; ?>" placeholder="<?php echo $entry_mobile; ?>" id="input-payment-mobile" class="form-control" />
		</div>
      </div>
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label" for="input-payment-address-2"><?php echo $entry_vatid; ?></label>
      <div class="col-sm-10">		
        <input type="text" name="address_2" value="" placeholder="<?php echo $entry_vatid; ?>" id="input-payment-address-2" class="form-control" />
		<font color="red">ระบุเมื่อต้องการขอใบกำกับภาษี</font><font color="blue">บุคคลธรรมดา ระบุเลขบัตรประชาชน ส่วนนิติบุคคล ระบุเลขผู้เสียภาษี ตามด้วยรหัสสาขา (ถ้ามี) </font><font color="black">
		<U>ตัวอย่าง</U> 3181012220 สาขา  1855</font>		
      </div>
    </div>
    <div class="form-group required">
