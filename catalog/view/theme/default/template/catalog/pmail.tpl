...
<?php }elseif(isset($mpseller)){?>
<title><?php echo $text_mpsellersubject; ?></title>
<?php } ?>
</head>
...
<div class="bottom" style="width: 100%;margin: auto;font-size: 14px;font-weight: bold;padding-top: 8px;text-align: center;"><?php echo $text_thanksadmin.$customer['firstname']; ?></div>
	...
	<span class="hi" style="font-size:22px;color:#004274;display: block;"><?php echo $text_hello.$mp_seller['firstname'].' '.$mp_seller['lastname'].' ,'; ?></span>

	<span style=" display: block;margin: 5px 0px;color: #004274;font-size: 13px; "> <?php echo $text_to_sellermail; ?></span>
	<br>
