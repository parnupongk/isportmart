<?php
class ModelAffiliateSale extends Model {
	...
	public function getOrders($data = array()) {
		...
		/*if (!empty($data['affiliate_id'])) {
			$sql .= " AND o.affiliate_id = '" . (int)$data['affiliate_id'] . "'";
		}*/
		 $sql .= " AND o.affiliate_id = '" . (int)$this->affiliate->getId() . "'";
...
//echo $sql;
	...
	public function getTotalOrders($data = array()) {
		...
		/*if (!empty($data['affiliate_id'])) {
			$sql .= " AND affiliate_id = '" . (int)$data['affiliate_id'] . "'";
		}*/
	    $sql .= " AND affiliate_id = '" . (int)$this->affiliate->getId() . "'";
