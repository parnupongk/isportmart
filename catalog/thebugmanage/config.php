...
if (strpos($_SERVER['HTTP_HOST'], '203.149.') !== false ) {
	...
	define('HTTPS_SERVER', 'http://' . $_SERVER['HTTP_HOST']. '/ishop/thebugmanage/');
	define('HTTPS_CATALOG', 'http://' . $_SERVER['HTTP_HOST']. '/ishop/');
	
} else {
	define('HTTP_SERVER', 'http://' . $_SERVER['HTTP_HOST']. '/thebugmanage/');
	define('HTTP_CATALOG', 'http://' . $_SERVER['HTTP_HOST']. '/');

	define('HTTPS_SERVER', 'http://' . $_SERVER['HTTP_HOST']. '/thebugmanage/');
