      ...
      <div class="panel-body">
	    ...
	    <div class="col-sm-3">
	      <div class="form-group">
                <label class="control-label" for="input-email"><?php echo $entry_email; ?></label>
                <input type="text" name="filter_email" value="<?php echo $filter_email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email" class="form-control" />
		<input type="hidden" name="filter_customer_group_id" value="*" id="input-customer-group" class="form-control">
		<input type="hidden" name="filter_status" value="*" id="input-status" class="form-control">
		<input type="hidden" name="filter_approved" value="*" id="input-approved" class="form-control">
		<input type="hidden" name="filter_ip" value="<?php echo $filter_ip; ?>" id="input-ip" class="form-control" />
		<input type="hidden" name="filter_date_added" value="<?php echo $filter_date_added; ?>" id="input-date-added" class="form-control" />
	      </div>
	    </div>
	    <?php } ?>
            <div class="col-sm-3">
		...
		<button type="button" id="button-filter" class="btn btn-primary pull-center"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button>
	    </div>
	    <?php } ?>
          </div>
        </div>
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-customer">
		  ...
		  <!--Kit add 24/03/2016 -->
		  <?php }
		  if($filter_user_group == 'CustService' || $filter_user_group == 'Agent'){ ?>
		  <td class="text-left"><?php echo $column_informtype; ?></td>
		  <?php } ?>
		  ...
		  <td class="text-left"><?php echo $customer['telephone']; ?> , <?php echo $customer['mobile']; ?> , <?php echo $customer['fax']; ?>, <?php echo $customer['custom_field']; ?></td> <!-- Kit Add  -->
		   <!--Kit add 24/03/2016 -->
		  <?php if($filter_user_group != 'CustService' && $filter_user_group != 'Agent'){ ?>
		  ...
		  <?php } 
		  if($filter_user_group == 'CustService' || $filter_user_group == 'Agent'){ ?>
		 <td class="text-center"><?php if($customer['informtype'] == 'E') { echo "Email"; } elseif($customer['informtype'] == 'S'){echo "SMS";} else {echo $customer['informtype'];} ?></td>
		  <?php } ?>
...
$('#button-filter').on('click', function() {
	...
	if ($('input[name=\'filter_customer_group_id\']').val() == '*')
	{
	...
	if ($('input[name=\'filter_status\']').val() == '*')
	{
	...
	if ($('input[name=\'filter_approved\']').val() == '*')
	{
		var filter_approved = $('input[name=\'filter_approved\']').val();
	}else{
