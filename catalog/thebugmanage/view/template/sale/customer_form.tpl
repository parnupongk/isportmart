      ...
      <div class="panel-body">
	    ...
	    <?php } ?>
          ...
          <div class="tab-content">
                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
					  ...
					  <!-- koy add 26/4/2016 -->
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-informtype"><?php echo $entry_informtype; ?></label>
                        <div class="col-sm-10">
                          <select name="informtype" id="input-informtype" class="form-control">
						  <?php if ($informtype == '') {?>
		    ...
		    <!-- Kit Add -->
		    <?php } else { ?>
		    <input type="hidden" name="password" value="<?php echo $password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-password" class="form-control" autocomplete="off" />
		    <input type="hidden" name="confirm" value="<?php echo $confirm; ?>" placeholder="<?php echo $entry_confirm; ?>" autocomplete="off" id="input-confirm" class="form-control" />
		    <input type="hidden" name="newsletter" value="<?php echo $newsletter; ?>" id="input-newsletter" class="form-control">
		    <input type="hidden" name="status" value="<?php echo $status; ?>" id="input-status" class="form-control">
		    <input type="hidden" name="approved" value="<?php echo $approved; ?>" id="input-approved" class="form-control">
		    <input type="hidden" name="safe" value="<?php echo $safe; ?>" id="input-safe" class="form-control">
		    <!-- Kit Add -->
		    <?php } ?>
		    </div>
                    <?php $address_row = 1; ?>
		  ...
		  <input type="hidden" name="user_id" value="<?php echo $filter_user_id; ?>" id="input-user-id" class="form-control" />
  ...
  e.preventDefault();
	...
	$.ajax({
		...
		data: 'comment=' + encodeURIComponent($('#tab-history textarea[name=\'comment\']').val()) + 
				'&order_id=' + encodeURIComponent($('#tab-history input[name=\'order_id\']').val()) +  // one add
				'&user_id=' + encodeURIComponent($('#tab-history input[name=\'user_id\']').val()),
		beforeSend: function() {
