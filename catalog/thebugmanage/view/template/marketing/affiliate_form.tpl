        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-affiliate" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <!-- Kit Edit Delete lastname = Shop-->
              <input type="hidden" name="lastname" value="Shop" placeholder="<?php echo $entry_lastname; ?>" id="input-lastname" class="form-control" />
              <!--<div class="form-group required">
            ...
            <div class="tab-pane" id="tab-payment">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-affiliatetype">Affiliate Type</label>
                <div class="col-sm-10">
                 <select name="affiliatetype" id="input-affiliatetype" class="form-control">
                    <?php if ($affiliatetype == 'VENDOR') { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-affiliatetype">DNIS (for Media only)</label>
                <div class="col-sm-10">
                 <input type="text" name="dnis" value="<?php echo $dnis; ?>" placeholder="" id="input-dnis" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <?php 
                	//echo $help_commission; 
                	if ($affiliatetype=='VENDOR') {
                		echo 'WHT3% is service sale (no stock product) OR  0% is goods sale';
                	} else {
                		echo '% Media receives on each order';
                	}                	
                ?>
                ">
                <?php 
                	//echo $entry_commission; 
                	if ($affiliatetype=='VENDOR') {
                		echo 'WHT 0% or 3%';
                	} else {
