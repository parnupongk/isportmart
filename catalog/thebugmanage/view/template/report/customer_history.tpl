  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<td class="text-left"><?php echo $column_customer_order; ?></td>
                <td class="text-left"><?php echo $column_comment; ?></td>
                <td class="text-left"><?php echo $column_user_info; ?></td>
            ...
            <tbody>
              ...
              <tr>
                <td class="text-left"><?php echo $history['customer_name']; ?></td>
		<td class="text-left"><?php echo $history['customer_order']; ?></td>
                <td class="text-left"><?php echo $history['comment']; ?></td>
                <td class="text-left"><?php echo $history['user_info']; ?></td>
