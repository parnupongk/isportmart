...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <!--/div-->
    <div class="row">
    	<?php //echo $data['recent'];?>
      <!--<div class="col-lg-4 col-md-4 col-sm-12 col-sx-12"><?php echo $activity; ?></div>-->
      <!--div class="col-lg-8 col-md-8 col-sm-12 col-sx-12"> <?php echo $recent; ?> </div>-->
