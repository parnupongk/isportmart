...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><b><h2>iSportMart</h2></b>
  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">
    	<span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
    ...
    <!-- <li><a href="<?php echo $order_status; ?>" style="display: block; overflow: auto;"><span class="label label-warning pull-right"><?php echo $order_status_total; ?></span><?php echo $text_order_status; ?></a></li>
       ...
       --> 
       <li><a href="<?php echo $pending_payment; ?>" style="display: block; overflow: auto;"><span class="label label-warning pull-right"><?php echo $pending_payment_total; ?></span><?php echo $text_order_wait; ?></a></li>
       <li><a href="<?php echo $wait_vendors_action; ?>"><span class="label label-success pull-right"><?php echo $wait_vendors_action_total; ?></span><?php echo $text_aff_wait; ?></a></li>
       <li><a href="<?php echo $pending_return; ?>"><span class="label label-danger pull-right"><?php echo $pending_return_total; ?></span><?php echo $text_return; ?></a></li>
      </ul>
    </li>
