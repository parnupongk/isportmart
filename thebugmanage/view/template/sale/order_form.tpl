      ...
      <div class="panel-body">
        <form class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-customer">            	
            	<input type="hidden" name="store_id" id="input-store" value="0" />
              ...
              <input type="hidden" name="currency" id="input-currency" value="THB" />
              <!--div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <!--- one add -begin @ 20160530-->
			    <?php foreach ($customer_groups as $customer_group) { ?>
                    <?php if ($customer_group['customer_group_id'] == $customer_group_id) { ?>                  
                  <input type="text" name="customer_group_name" value="<?php echo $customer_group['name']; // .', ' .  $customer_group['customer_group_id'] .', ' .$customer_group_id; ?>" class="form-control" readonly />
                  <input type="hidden" name="customer_group_id" id="input-customer-group" value="<?php echo $customer_group_id; ?>" />                  
                    <?php }  }  ?>
                   <!--- one add -end @ 20160530-->
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-cart">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="affiliate" value="<?php echo $affiliate; ?>" id="input-affiliate" class="form-control" readonly/><!-- Kit add readonly -->
                ...
                <table class="table table-bordered">
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
                      ...
                      <td class="text-right"></td>
                      <td class="text-center"><input type="hidden" name="product[<?php echo $product_row; ?>][filter_user_group]" value="<?php echo $filter_user_group; ?>" /></td>
                    </tr>
                    <?php $product_row++; ?>
                    <?php } ?>
                    <?php $voucher_row = 0; ?>
	      ...
	      <!-- Kit add  -->
	      <?php if($filter_user_group != 'Agent'){ ?>
		...
		<?php } ?>
            ...
            <div class="tab-pane" id="tab-payment">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-payment-address-2">เลขผู้เสียภาษีอากร<?php //echo $entry_address_2; ?></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-shipping">
              <div class="form-group">                
              	<label class="col-sm-2 control-label" for="copy-address">&nbsp;</label>
                <div class="col-sm-10">
                <input type="checkbox"  id="copy-address" name="copy-address" value="1" />&nbsp;&nbsp;Copy - Payment address
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <fieldset>
				...
				<input type="text" value="<?php echo $shipping_method; ?>" readonly>
				</div><br>-->
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-shipping-method"><?php echo $entry_shipping_method; ?></label>
                  <div class="col-sm-10">
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                      <button type="button" id="button-shipping-method" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary">ยืนยันก่อนบันทึก</button>
              ...
              <input type="hidden" name="coupon" id="input-coupon" value="" />
              ...
              <input type="hidden" name="reward" id="input-reward" value="" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="order_status_id" id="input-order-status" class="form-control">
                      ...
                      <?php foreach ($order_statuses_seq as $order_status) { ?>
                ...
                <div class="form-group">
                  ...
                  <?php  //echo $entry_comment; ?>หมายเหตุการจัดส่ง</label>
                  <div class="col-sm-10">
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/cart/products&store_id=0',
		dataType: 'json',
...
$('select[name=\'currency\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/currency&store_id=0',
		type: 'post',
...
$('input[name=\'customer\']').autocomplete({
	...
	'select': function(item) {
		...
		//$('#tab-customer select[name=\'customer_group_id\']').val(item['customer_group_id']);  // one remark
		$('#tab-customer input[name=\'customer_group_id\']').val(item['customer_group_id']);
		...
		//$('select[name=\'customer_group_id\']').trigger('change');  // one remark
...
$('#copy-address').on('change', function() {
		if ( this.value == '1') {
			$('#tab-shipping input[name=\'firstname\']').val(  $('#tab-payment input[name=\'firstname\']').val()  );
			$('#tab-shipping input[name=\'lastname\']').val(  $('#tab-payment input[name=\'lastname\']').val()  );
			$('#tab-shipping input[name=\'company\']').val(  $('#tab-payment input[name=\'company\']').val()  );			
			//$('#tab-shipping input[name=\'company\']').val(  $('#tab-cart input[name=\'affiliate_id\']').val()  );
			$('#tab-shipping input[name=\'address_1\']').val(  $('#tab-payment input[name=\'address_1\']').val()  );
			$('#tab-shipping input[name=\'address_2\']').val(  $('#tab-payment input[name=\'address_2\']').val()  );
			$('#tab-shipping input[name=\'city\']').val(  $('#tab-payment input[name=\'city\']').val()  );
			$('#tab-shipping input[name=\'postcode\']').val(  $('#tab-payment input[name=\'postcode\']').val()  );
			$('#tab-shipping select[name=\'zone_id\']').val(  $('#tab-payment select[name=\'zone_id\']').val()  );		
		} 
});
...
$('#button-customer').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/customer&store_id=0', 
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				$.ajax({
					url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/cart/add&store_id=0',
					type: 'post',
				...
				$.ajax({
					url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/voucher/add&store_id=0',
					type: 'post',
...
$('#tab-product input[name=\'product\']').autocomplete({
	'source': function(request, response) {
		$.ajax({			
			url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_affiliate_id=' +  $('#tab-cart input[name=\'affiliate_id\']').val() +'&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
						...
						model: item['model'],
						option: item['option'],
						affiliate_id: item['affiliate_id'],  // one add @ 12/07/2016
						price: item['price']						
					}
				}));
			}
	...
	'select': function(item) {
		$('input[name=\'affiliate_id\']').val(item['affiliate_id']); // one add @ 12/07/2016
...
$('#tab-cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/cart/remove&store_id=0',
		type: 'post',
...
$('#button-payment-address').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/payment/address&store_id=0',
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Payment Methods
				$.ajax({
					url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/payment/methods&store_id=0',
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-address').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/shipping/address&store_id=0',
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Shipping Methods
				$.ajax({
					url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/shipping/methods&store_id=0',
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/shipping/method&store_id=0',
		type: 'post',
...
$('#button-payment-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/payment/method&store_id=0',
		type: 'post',
...
$('#button-coupon').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/coupon&store_id=0',
		type: 'post',
...
$('#button-voucher').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/voucher&store_id=0',
		type: 'post',
...
$('#button-reward').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/reward&store_id=0',
		type: 'post',
...
$('#button-save').on('click', function() {
	...
	if (order_id == 0) {
		var url = 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/order/add&store_id=0';
	} else {
		var url = 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/order/edit&store_id=0&order_id=' + order_id + '&user_id=' + user_id;
	}
	
	$.ajax({
		url: url,
		type: 'post',
		data: $('#tab-total select[name=\'order_status_id\'], #tab-total select, #tab-total textarea[name=\'comment\'], #tab-cart input[name=\'affiliate_id\']'),
		dataType: 'json',
		beforeSend: function() {
