  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo $address; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_shipping_print; ?>" class="btn btn-info"><i class="fa fa-print"></i></a> 
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
          ...
          <li><a href="#tab-verifier" data-toggle="tab"><?php echo $tab_verifier; ?></a></li>
        ...
        <div class="tab-content">
            ...
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><?php if ($invoice_no) { ?>
                  <?php echo $invoice_no . '  [ '. $payment_method .' ] '; ?>
                  <?php } else { ?>
                  <?php echo '  [ '. $payment_method .' ]'; ?>
                  <!-- one remark @ 16/06/2016 -->
              ...
              <tr>
                ...
                <td>
                	<!--nid add 18/3/2016 16:15 -->
                	  <?php if($filter_user_group != 'CustService' && $filter_user_group != 'Agent'){ ?>
                	 <a href="<?php echo $store_url; ?>" target="_blank"><?php echo $store_url; ?></a>
                	 <?php }else{ ?>
                	 <?php echo $store_url; ?>
                	 <?php } ?>
                	 <!--nid add 18/3/2016 16:15 -->
                ...
                <td>
                	<!--nid add 18/3/2016 16:15 -->
                	 ...
                	 <a href="<?php echo $customer; ?>" target="_blank"><?php echo $firstname; ?> <?php echo $lastname; ?></a>
                	  <?php }else{ ?>
                	 <?php echo $firstname; ?>&nbsp;<?php echo $lastname; ?>&nbsp;&nbsp;(<font color='blue'><?php echo $telephone; ?></font>)
                	 <?php } ?>
                	 <!--nid add 18/3/2016 16:15 -->
               </td>
              </tr>
              ...
              <tr>
                ...
                <td><?php echo $telephone; ?>&nbsp;&nbsp;
                	...
                	<a href="http://app.bug1113.com/tv/sms_corp_check.php?ani=<?php 
                		if (strpos($telephone, ' ') > 0 ){
                			$telephone = explode(" ", $telephone);                			
						echo $telephone[1]; 
					} else {
						echo $telephone; // piece2
					}
                		?>" target="_blank" data-toggle="tooltip" title="Check SMS" class="btn btn-info">Check SMS</a> 
                </td>
              </tr>
              <?php if ($fax) { ?>
              <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php }else{ ?>
                	 <?php echo $affiliate_firstname; ?> <?php echo $affiliate_lastname; ?>&nbsp;(<font color='blue'><?php echo $affiliate_telephone; ?></font>)
                	 <?php } ?>
                	 <!--nid add 18/3/2016 16:15 -->
                </td>
              </tr>
          ...
          <div class="tab-pane" id="tab-payment">
            <table class="table table-bordered">
              ...
              <tr>
                <td>เลขผู้เสียภาษีอากร<?php //echo $text_address_2; ?></td>
          ...
          <div class="tab-pane" id="tab-verifier">   
            <table class="table table-bordered">
              <tr>
                <td><?php echo $text_agent_id; ?></td>
                <td><?php echo $confirm_agent_id; ?></td>
              </tr>
              <tr>
                <td><?php echo $text_date_confirm; ?></td>
                <td><?php echo $confirm_date_confirm; ?></td>
              </tr>
              <tr>
                <td><?php echo $text_totals; ?></td>
                <td><?php echo $confirm_total; ?></td>
              </tr>
              <tr>
                <td><?php echo $text_type; ?></td>
                <td><?php echo $confirm_type; ?></td>
              </tr>
              <tr>
                <td><?php echo $text_remark; ?></td>
                <td><?php echo $confirm_remark; ?></td>
              </tr>
               <tr>
                <td><?php echo $text_payslip; ?></td>
                <?php if(!empty($confirm_picname)){?>
                <td><?php 
                	//echo "<img src=http://" . $_SERVER['HTTP_HOST'] . "/system/download/".$confirm_picname."><br>Filename:".$confirm_picname."&nbsp;&nbsp;Date added:".$confirm_pic_date_added. "<br>"; 
          ...
          <div class="tab-pane" id="tab-shipping">
            <table class="table table-bordered">
              ...
              <?php } ?>
              <!--  one add : begin @ 25/04/2016-->               
              <tr>
                <td>หมายเหตุการจัดส่ง:</td>
          ...
          <div class="tab-pane" id="tab-history">
            <div id="history"></div>
            <br />
             <!--nid add 18/3/2016 16:56 -->
              <?php if($filter_order_status == '15' && $filter_user_group == 'CustService'){}else if($filter_order_status == '15' && $filter_user_group == 'Agent'){}else{ ?>
            <fieldset>
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="order_status_id" id="input-order-status" class="form-control">
                      ...
                      <?php foreach ($order_statuses_seq as $order_statuses) { ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-comment">
                  	<?php //echo $entry_comment; ?>หมายเหตุ สถานะคำสั่งซื้อ</label>
                  <div class="col-sm-10">
...
$('#button-history').on('click', function() {
  ...
  /*}else{
	...
	$.ajax({
		url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/order/history&order_id=<?php echo $order_id; ?>&user_id=<?php echo $user_id; ?>',
		type: 'post',
		dataType: 'json',
