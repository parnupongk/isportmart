            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">WHT(VENDOR), Commission(MEDIA)</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $affiliate['affiliatetype'] . ' ' .$affiliate['dnis']  ; ?></td> 
                  <td class="text-left"><?php 
                  	if ($affiliate['affiliatetype'] == 'VENDOR') {
                  		if ($affiliate['commission']=='0') {
                  			echo 'Goods (No WHT)'; 
                  		} else {
                  			echo 'Service (WHT ' . $affiliate['commission'] . '%)'; 
                  		}
                  	} else {
                  		echo 'Commission: ' . $affiliate['commission'] .'%'; 
                  	}
                  ?></td> 
